                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <button name="delete" style="width:10%;" type="submit" id="delete" class="btn btn-danger">Delete</button></td>
                                        </tr>
                            ...
                            <?php
                                if(isset($_POST['delete']))
                                {
                                    if(@$checkbox = $_POST['checkbox'])
                                    {
                                      ...
                                      {
                                        $del_id = $checkbox[$i];
                                        $sql = "DELETE FROM examschedule WHERE id='$del_id'";
                                        $result = mysqli_query($stat,$sql);
                                      }
                                      echo"
                                      ...
                                      echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_delexamschedule.php\">";                  
                                    }
                                    else
                                    {
                                      echo"
