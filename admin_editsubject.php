                                ...
                                <table class="table table-bordered table-hover table-striped">
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                            <tr>
                                                <?php $id[$i] = $rows['id']; $name1[$i] = $rows['name']; $i++; ?>  
                                                <td><?php echo $i; ?></td>
                                                <td><input type="text" id="nam1[]" name="nam1[]" class="form-control" value="<?php echo $rows['name']; ?>"></td>
                                            </tr>
                                            <?php
                                            }
                                        ?>
                                ...
                                if(isset($_POST['edit']))
                                {
                                    ...
                                    for($i=0;$i<$count;$i++)
                                    {
                                        if(trim($nam1[$i])!="")
                                        {
                                                $n1=$nam1[$i];
                                                $n2=$name1[$i];
                                                $sql1 = "UPDATE subject SET name='$n1' WHERE name='$n2'";
                                                $result1=mysqli_query($stat,$sql1);
                                                $sql1 = "UPDATE marks SET subj='$n1' WHERE subj='$n2'";
                                                $result1=mysqli_query($stat,$sql1);
                                                for ($j=0; $j <=5 ; $j++) 
                                                { 
                                                    $sql1 = "UPDATE teacher SET subject".$j."='$n1' WHERE subject".$j."='$n2'";
                                                    $result1=mysqli_query($stat,$sql1);
                                                }
                                                $sql1 = "UPDATE class SET subject='$n1' WHERE subject='$n2'";
                                                $result1=mysqli_query($stat,$sql1);
                                                for ($j=0; $j <=5 ; $j++) 
                                                { 
                                                    $sql1 = "UPDATE class SET subject".$j."='$n1' WHERE subject".$j."='$n2'";
                                                    $result1=mysqli_query($stat,$sql1);
                                                }
                                                for ($j=1; $j <=10 ; $j++) 
                                                { 
                                                    $sql1 = "UPDATE timetable SET period".$j."='$n1' WHERE period".$j."='$n2'";
                                                    $result1=mysqli_query($stat,$sql1);
                                                }
                                        }
                                        else
                                        {
                                            ...
                                            ?>
                                            <script>
                                            document.getElementById("incor1").innerHTML="Subject name cannot be empty!!!";
                                            </script>
                                            <?php 
                                        }
                                    }
                                    if($f!=0)
                                    {
                                      ...
                                      echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_editsubject.php\">";
                                    }
                                }
                                ?>
