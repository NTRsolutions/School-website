        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<tr>
					...
					<?php
						$y=$rows['classteacher'];
						$query1="SELECT * from teacher WHERE username='$y'";
					...
					<?php 
						...
						{ 
							...
							if($rows['subject'.$j]!="")
							{
								?>
									<tr>
										<td><b><?php echo $rows['subject'.$j]." Teacher"  ; ?></b></td>
										<?php
											$y=$rows['teacher'.$j];
											$query1="SELECT * from teacher WHERE username='$y'";
											$result1=mysqli_query($stat,$query1);	
                		...
                		<?php 
            			$query2="SELECT * from student WHERE std='$x'";
...
<?php 
	...
	{?>
		<div style="width: 70%; ">
			<h2>
			<table style="color: black;font-family: Helvetica; font-size: 28px; background-color: white;">
