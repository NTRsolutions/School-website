                    ...
                    <div class="col-lg-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    <form enctype="multipart/form-data" method="post" action="editteacher1.php">
        
                                        <div hidden="true" class="field-wrap">
                                            <input value="<?php echo $x ?>" name="usname" type="text" ></input>
                                            <input value="<?php echo $p ?>" name="image" type="text" ></input>
                                        </div>
                                        <tr>
                                            <td><strong>Teacher Name</strong></td>
                                            <td><input class="form-control"  style="width:50%;" value="<?php echo $rows['name']; ?>" name="teachname" type="text" required autocomplete="off"></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Address</strong></td>
                                            <td><textarea class="form-control" rows="5" style="width:475px" name="address" required autocomplete="off" ><?php echo $rows['address']; ?></textarea></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Contact No.</strong></td>
                                            <td><input class="form-control" style="width:50%;" value="<?php echo $rows['contactno']; ?>" name="contact" type="text" required autocomplete="off"></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Qualification</strong></td>
                                            <td><input class="form-control" style="width:50%;" value="<?php echo $rows['qualification']; ?>" name="qual" type="text" required autocomplete="off"></td>
                                        </tr>
                                        <tr>
                                            <td><strong>Designation</strong></td>
                                            <td><input class="form-control" style="width:50%;" value="<?php echo $rows['designation']; ?>" name="des" type="text" required autocomplete="off"></td>
                                        </tr>
                                        
                                        <tr>
                                            <td><strong>Image</strong></td>                                            
                                            <td>
                                            <input class="form-control" style="width:30%" type="file" id="img" name="img" autocomplete="off"><br>
                                            <img width="20%" src="image/<?php echo $rows['photo']; ?>">
                                            </td>
                                        </tr>
                                        <div class="field">
                                        ...
                                        <tr>
                                            <td colspan="2" align="center"><button style="width:10%" name="submit" class="btn btn-success" type="submit" >Edit</button></td>
