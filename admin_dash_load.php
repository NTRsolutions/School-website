	...
	function succ()
    {
        echo"
         <script type='text/javascript'>
            ...
            ;
        echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_dash_edit.php\">";
    }
...
if(isset($_SESSION['dash_name']))
{
   ...
   {
       require_once("db.php");
       $check="SELECT * FROM dashboard WHERE author='".$_SESSION['name']."' && id='".$_GET['id']."'";
	   $result=mysqli_query($stat,$check);
	   if(mysqli_num_rows($result)==0)
	      header("refresh:0;url=admin_dash_edit.php");
$title_flag=0;
$format_flag=0;
$description_flag=0;
$flag=0;
			  ...
			  <li>
			   ...
			   ?>
				 ...
				 ?>	
                    ...
                    <button onclick="location.href='admin_dash_edit.php'" class="btn btn-lg btn-default">Cancel</button>			   
                </div>
                <!-- /.row -->
