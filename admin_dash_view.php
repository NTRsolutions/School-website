...
$err=0;
 if(isset($_POST['submit']))
 {
     if(isset($_POST['post']))
     {
        header("refresh:0;url=admin_dash_view_post.php?id=".$_POST['post']);
     }
     else
      {
        $err=1;
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<strong>
				You need to choose a post to view it.
				</strong>
                                    </div>
                          <?php }
			   ?>	
				...
				<strong>
				Use the radio button to choose the post which you wish to view.
				</strong>
                                    </div>
					...
					<?php
					$query="SELECT * FROM dashboard WHERE author='".$_SESSION['name']."' ORDER BY id DESC";
					...
					<?php } ?>
					 ...
					 <button name="submit" id="submit" type="submit" class="btn btn-lg btn-success">View</button>	
					 <br/>
					 <br/>
				    </div>
