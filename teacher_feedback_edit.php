            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <?php
                            $count=0;
                            $query1="SELECT * FROM feedback WHERE teacher='$username' order by std,regno";
                                    ...
                                    <tr>
                                        <?php
                                            ...
                                            ?>
                                                ...
                                                <td><input class="form-control" type="text" name="remark[]" value="<?php echo $row['remark'];?>"></td>
                                            <?php
                                            }
                                            $id[$i-1]=$row['id'];
                                            $i++; ?>  
                        ...
                        <?php 
                                if(isset($_POST['edit']))
                                {
                                    ...
                                    if($f==0)
                                    {
                                        ?>
                                        <script>
                                            document.getElementById("incor1").innerHTML="Remarks cannot be empty!!";
                                        </script>
                                        <?php
                                    }
                                    else
                                    {
                                        ...
                                        for($i=0;$i<$count;$i++)
                                        {
                                            $a=trim($remark[$i]);
                                            $id1=$id[$i];
                                            $sql1 = "UPDATE feedback SET remark='$a' WHERE id='$id1'";
                                        ...
                                        if($f!=0)
                                        {
                                          ...
                                          echo "<meta http-equiv=\"refresh\" content=\"0;URL=teacher_feedback_edit.php\">";
                                        }
                                    }
