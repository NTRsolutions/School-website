    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
			...
			<ul class="nav navbar-nav side-nav">
                ...
                <li class="active"><a href="admin.php"><i class="fa fa-fw fa-home"></i> Home</a></li>
                 <li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    <?php
                                        require_once('db.php');
                                        $quer="SELECT * from teacher";
                                        $resul=mysqli_query($stat,$quer);   
                                        $no_teach=mysqli_num_rows($resul);
                                        $quer="SELECT * from class";
                                        $resul=mysqli_query($stat,$quer);   
                                        $no_sec=mysqli_num_rows($resul);
                                        $quer="SELECT * from student";
                                        $resul=mysqli_query($stat,$quer);   
                                        $no_stu=mysqli_num_rows($resul);
                                    ?>
                                    <tr>
                                        <td><strong>Students</strong></td>
                                        <td><?php echo $no_stu ;?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Teachers</strong></td>
                                        <td><?php echo $no_teach ;?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Class</strong></td>
                                        <td><?php echo $no_sec ;?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
