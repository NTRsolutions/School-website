                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    ...
                                    <form enctype="multipart/form-data"  method="post" action="edittimetable1.php">
                                    <div hidden="true" class="field-wrap">
                                        <input value="<?php echo $std ?>" name="std" type="text" ></input>
                                    </div>
                                    <?php
                                    $quer1="SELECT * from timetable WHERE std='$std';";
                                            ...
                                            ?>
                                                <tr>
                                                   ...
                                                   switch($i)
                                                   {
                                                    ...
                                                    $quer="SELECT * from class WHERE std='$std';";
                                                    $resul=mysqli_query($stat,$quer);   
                                                    if($row=mysqli_fetch_array($resul))
                                                    {
                                                        ...
                                                        ?>
                                                            <td>
                                                               <select class="tab" style="width:87px;" id="<?php echo "select".$i.$j;?>" name="<?php echo "select".$i.$j;?>">
                                                                    <?php
                                                                    $p="period".($j+1);
                                                                    if($row1[$p]=="NONE")
                                                                    {
                                                                    ...
                                                                    for($k=0;$k<10;$k++)                        
                                                                    {
                                                                        ...
                                                                        if($row[$sub]!=NULL)
                                                                        {
                                                                            ...
                                                                            {
                                                                                ?>
                                                                                <option selected value="<?php echo $row[$sub]; ?>"><?php echo $row[$sub] ; ?></option>
                                                                               <?php
                                                                            }
                                                                            else
                                                                            {
                                    ...
                                    <button style="width:10%;" name="submit" type="submit" class="btn btn-success">Submit</button>
