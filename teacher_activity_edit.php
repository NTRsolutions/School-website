                                    ...
                                    <tr>
                                        <?php
                                            ...
                                            ?>
                                                ...
                                                <td><input class="form-control" type="text" name="activity[]" value="<?php echo $row['activity'];?>"></td>
                                            <?php
                                            }
                                            $id[$i-1]=$row['id'];
                                            $i++; ?>  
                        ...
                        <?php 
                                if(isset($_POST['edit']))
                                {
                                    ...
                                    if($f==0)
                                    {
                                        ?>
                                        <script>
                                            document.getElementById("incor1").innerHTML="Activity cannot be empty!!";
                                        </script>
                                        <?php
                                    }
                                    else
                                    {
                                        ...
                                        for($i=0;$i<$count;$i++)
                                        {
                                            $a=trim($activity[$i]);
                                            $id1=$id[$i];
                                            $sql1 = "UPDATE activity SET activity='$a' WHERE id='$id1'";
                                        ...
                                        if($f!=0)
                                        {
                                          ...
                                          echo "<meta http-equiv=\"refresh\" content=\"0;URL=teacher_activity_edit.php\">";
                                        }
                                    }
