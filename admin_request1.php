            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Click on the Name to view Student Details.
                            </li>
                        </ol>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    ...
                                    <?php
                                        require('db.php');
                                        $sql="SELECT * FROM request WHERE status='Processing'";
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td><a href = "liststudent.php?reg=<?php echo $rows['regno'];?>"><?php echo $n; ?></a></td>
                                            <td><?php echo $row1['std']; ?></td>
                                        ...
                                        <table class="table table-bordered table-hover table-striped">
                                        <tr>
                                            <td align="center" ><input style="width:100%; color: #fff;background-color: #5cb85c;border-color: #4cae4c; height:35px;border-radius:10px" name="accept" type="submit" value="Accept"></td>
                                            <td align="center" ><input style="width:100%; color: #fff;background-color: #d9534f;border-color: #d43f3a; height:35px;border-radius:10px" name="reject" type="submit" value="Reject"></td>
                                        </tr>
                                        </table>
                                        <?php
                                        }
                            ...
                            <?php
                                if(isset($_POST['accept']))
                                {
                                    if(@$checkbox = $_POST['checkbox'])
                                    {
                                      ...
                                      {
                                        $del_id = $checkbox[$i];
                                        $sql = "UPDATE request SET status='Accepted' WHERE id='$del_id'";
                                        $result = mysqli_query($stat,$sql);
                                      }
                                      echo"
                                        <script type='text/javascript'>
                                        alert('".count($checkbox)." Request Processed Succesfully!!');
                                        </script>";
                                        echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_request1.php\">";                                                          
                                    }
                                    else
                                    {
                                      echo"
                                ...
                                else if(isset($_POST['reject']))
                                {
                                    if(@$checkbox = $_POST['checkbox'])
                                    {
                                      ...
                                      {
                                        $del_id = $checkbox[$i];
                                        $sql = "UPDATE request SET status='Rejected' WHERE id='$del_id'";
                                        $result = mysqli_query($stat,$sql);
                                      }
                                      echo"
                                        <script type='text/javascript'>
