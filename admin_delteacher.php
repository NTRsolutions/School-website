                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td id="unam[]" name="unam[]"><?php echo $rows['username']; ?></td>
                                       ...
                                       <tr>
                                <td colspan="4" align="center" ><button name="delete1" type="submit" id="delete1" class="btn btn-danger" >Delete</button></td>
                            </tr>
                            ...
                            <?php
                                if(isset($_POST['delete1']))
                                {
                                    if(@$checkbox = $_POST['checkbox'])
                                    {
                                      ...
                                      {
                                        $del_id = $checkbox[$i];
                                        $sql = "SELECT * FROM teacher WHERE id='$del_id'";
                                        $result = mysqli_query($stat,$sql);
                                        ...
                                        $result = mysqli_query($stat,$sql);
                                        $sql = "UPDATE class SET classteacher='' WHERE classteacher='$na'";
                                        $result = mysqli_query($stat,$sql); 
                                        $sql = "UPDATE class SET teacher='' WHERE teacher='$na'";
                                        $result = mysqli_query($stat,$sql); 
                                        for ($j=1; $j <=9 ; $j++) 
                                        { 
                                            $sql = "UPDATE class SET teacher".$j."='' WHERE teacher".$j."='$na'";
                                            $result = mysqli_query($stat,$sql); 
                                        }
                                      }
                                      echo"
                                    ...
                                    else
                                    {
                                      echo"
                                        ...
                                        echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_delteacher.php\">";
                                    }
                                }
                                ?>
                                </tbody>
