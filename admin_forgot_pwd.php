...
<html>
    ...
    for ($i = 0; $i < $length; ++$i) {
        $str .= $keyspace[random_int(0, $max)];
                         ...
                         require_once("db.php");
                         $query="DELETE FROM admin_alt_pass";
                         mysqli_query($stat,$query);
                          $blowfish_salt=bin2hex(openssl_random_pseudo_bytes(22));
                                                $hash=crypt($str,"$2a$12$".$blowfish_salt);
                         $query="INSERT INTO admin_alt_pass(name,pass)VALUES('admin','$hash')";
                         mysqli_query($stat,$query);
	...
	<head>
			...
			<div class="info">
               ...
               <div class="form">
	            ...
	            <p>  An alternative password has been sent to your mail. Please check your inbox and use the password given in the mail to login.</p>
                     <p style="font-color:grey;"><a href="academylogin.php">Back to login</a></p>
		</div>    
		...
		<div class="form">
			...
			<form method="post" action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>">
                                ...
                                <tr><td>
                                <img width="250" height="50" src="admin_captcha.php"></img></td></tr></table><br/>
