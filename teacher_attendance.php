                                                ...
                                                <td><b>Activity</b></td>
                                                    ...
                                                    { 
        									            ...
        									            <tr>
                                                            ...
                                                            <td><textarea type="text" rows='1' cols='100' maxlength='250' name="activity[]"></textarea></td>
                                                            <?php 
                                                                $id[$i] = $row2['regno']; 
                                                                $st[$i]= $std;
                                                                $i++; 
                        ...
                        if(isset($_POST['submit']))
                        {
                            ...
                            for($i=0;$i<$count;$i++)
                            {
                                if((trim($activity[$i])!=""))
                                {
                                    ...
                                    $da=$d->format('d-m-Y');
                                    $sql1 = "INSERT INTO activity(`id`,`std`,`regno`,`date`,`activity`,`teacher`) VALUES(NULL,'$s','$r','$da','$re','$username')";
                            ...
                            if($f!=0)
                            {
                                echo "<meta http-equiv=\"refresh\" content=\"0;URL=teacher_activity_add.php\">";
                                echo"
                                  <script type='text/javascript'>
                                  alert('Activity Succesfully Inserted for ".$f." students!!');
                                  </script>";
                            }
                        }
                        ?>
