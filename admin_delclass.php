                    ...
                    <div class="col-lg-6">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><strong>Class Teachers</strong></td>
                                        <td><strong>Student</strong></td>
                                    </tr>
                                    <?php
                            require('db.php');
                            $sql="SELECT * FROM class ORDER BY std";
                            ...
                            <tr>
                                ...
                                <td id="std1[]" name="std1[]"><?php echo $rows['std']; ?></td>
                                <td ><?php echo $rows['classteacher']; ?></td>
                                <?php 
                                                $s=$rows['std'];
                                                $query2="SELECT * from student WHERE std='$s'";
                            ...
                            <tr>
                                <td colspan="4" align="center" ><button name="delete" type="submit" id="delete2" class="btn btn-danger">Delete</button></td>
                            </tr>
                            ...
                            <?php
                                if(isset($_POST['delete']))
                                {
                                    if(@$checkbox = $_POST['checkbox'])
                                    {
                                      ...
                                      {
                                        $del_id=$checkbox[$i];
                                        $sql1 = "SELECT * FROM class WHERE id='$del_id'";
                                        $result1= mysqli_query($stat,$sql1);
                                        if($row1 = mysqli_fetch_array($result1))
                                        {
                                            $del_std = $row1['std'];
                                            $sql = "DELETE FROM student WHERE std='$del_std'";
                                            $result = mysqli_query($stat,$sql);
                                            $sql = "DELETE FROM activity WHERE std='$del_std'";
                                            $result = mysqli_query($stat,$sql);
                                            $sql = "DELETE FROM feedback WHERE std='$del_std'";
                                            $result = mysqli_query($stat,$sql);
                                            $sql = "DELETE FROM timetable WHERE std='$del_std'";
                                            $result = mysqli_query($stat,$sql);
                                            $sql = "DELETE FROM marks WHERE std='$del_std'";
                                            $result = mysqli_query($stat,$sql);
                                        }
                                        $sql = "DELETE FROM class WHERE id='$del_id'";
                                        $result = mysqli_query($stat,$sql);
                                      }
                                      echo"
                                      ...
                                      echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_delclass.php\">";               
                                    }
                                    else
                                    {
                                      echo"
