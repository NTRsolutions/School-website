...
$err=0;
 if(isset($_POST['submit']))
 {
     if(isset($_POST['post']))
     {
        header("refresh:0;url=admin_dash_load.php?id=".$_POST['post']);
     }
     else
      {
        $err=1;
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<strong>
				You need to choose a post to edit it.
				</strong>
                                    </div>
                          <?php }
			   ?>	
				...
				<strong>
				Use the radio button to choose the post which you wish to edit.
				</strong>
                                    </div>
					...
					<?php } ?>
					 ...
					 <button name="submit" id="submit" type="submit" class="btn btn-lg btn-success">Edit</button>	
					 <br/>
					 <br/>
				    </div>
