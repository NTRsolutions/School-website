                        ...
                        <?php
                            ...
                            while($row=mysqli_fetch_array($result1))
                            {
                                ...
                                ?>
                                   <div class="table-responsive">
                                        <table class="table table-bordered table-hover table-striped">
                                            <tbody>
                                                ...
                                                <?php
                                                    $query="SELECT * from student WHERE std='$std' ORDER BY name;";
                                                    ...
                                                    {?>
                                                        <thead>
                                                            <tr>
                                                                <th  colspan="4"><h4><b><?php echo $std;?></b></h4></th>
                                                            </tr>
                                                        </thead>
                                                        <tr>
                                                            <td><b>#</b></td>
                                                    ...
                                                    while($rows=mysqli_fetch_array($result))
                                                    {
                                                        ...
                                                        ?>  <tr>
                                                                ...
                                                                <td id="regno[]" name="regno[]"><?php echo $reg ?></a></td>
                                  ...
                                  <?php  }
                                    ?>
                                        <button style="width:10%;" name="delete" type="submit" id="delete" class="btn btn-danger">Delete</button></td>
                                    </form>
                                    <?php
                                if(isset($_POST['delete']))
                                {
                                    if(@$checkbox = $_POST['checkbox'])
                                    {
                                      ...
                                      {
                                        $del_id = $checkbox[$i];
                                        $sql = "SELECT * FROM student WHERE id='$del_id'";
                                        $resul1 = mysqli_query($stat,$sql);
                                        if($rows1=mysqli_fetch_array($resul1))
                                        {
                                            $na=$rows1['regno'];
                                            $im=$rows1['photo'];
                                            unlink("student_image/".$im);
                                        }
                                        $sql = "DELETE FROM student WHERE id='$del_id'";
                                        $result = mysqli_query($stat,$sql);
                                        $sql = "DELETE FROM activity WHERE regno='$na'";
                                        $result = mysqli_query($stat,$sql); 
                                        $sql = "DELETE FROM feedback WHERE regno='$na'";
                                        $result = mysqli_query($stat,$sql); 
                                        $sql = "DELETE FROM attendance WHERE regno='$na'";
                                        $result = mysqli_query($stat,$sql); 
                                        $sql = "DELETE FROM library WHERE regno='$na'";
                                        $result = mysqli_query($stat,$sql); 
                                        $sql = "DELETE FROM marks WHERE regno='$na'";
                                        $result = mysqli_query($stat,$sql); 
                                        $sql = "DELETE FROM request WHERE regno='$na'";
                                        $result = mysqli_query($stat,$sql); 
                                      }
                                      echo"
                                    ...
                                    else
                                    {
                                      echo"
                                        ...
                                        echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_delstudent.php\">";
                                    }
                                }
                                ?>
                </div>
