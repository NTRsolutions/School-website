                    ...
                    <div class="col-lg-6">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                function data2(x1)
                                {
                                    $.get("class.php?class="+x1,function(data2,status2){document.getElementById('cont3').innerHTML=data2;});
                                }
                            </script>
                            <?php
                                require('db.php');
                                ...
                                while($rows=mysqli_fetch_array($result))
                                {
                                    ?>  <tr>
                                            <td><?php echo $i ?></td>
                                            <td><a href = "class.php?class=<?php echo $rows['std'];?>"><?php echo $rows['std'];?></td>
                                            <?php 
                                                $u=$rows['classteacher'];
                                                $query1="SELECT * from teacher WHERE username='$u'";
