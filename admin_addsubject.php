                            ...
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input value="<?php echo $subname; ?>" name="subname" class="form-control" type="text" required autocomplete="off"></td>
                                    </tr>
                                </tbody>
                            </table>
                           ...
                           function succ()
                           {
                            echo"
                              <script type='text/javascript'>
                                    ...
                                    ;
                                   echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_addsubject.php\">";
                           }
                            ...
                            if(isset($_POST['submit1']))
                            {
                                ...
                                {
                                    require_once('db.php');
                                    $query="SELECT * from subject WHERE name='$subname'";
                                    $result=mysqli_query($stat,$query);
                                    if(mysqli_num_rows($result)!=0)
                                    {
                                            ?>
                                            <script>
                                            document.getElementById("incor1").innerHTML="Subject Already Exist!!!";
                                            </script>
                                            <?php 
                                    }
                                    else
                                    {
                                       $flag=0;
                                       $query="INSERT INTO `subject` (`id`, `name`) VALUES (NULL, '$subname')";
