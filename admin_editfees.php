                        ...
                        <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control" type="text" name="particulars[]" value="<?php echo $rows['particulars']; ?>"></td>
                                                <td><input class="form-control" type="text" name="amount[]" value="<?php echo $rows['amount']; ?>"></td>
                            ...
                            <?php 
                                if(isset($_POST['edit']))
                                {
                                    ...
                                    for($i=0;$i<$count;$i++)
                                    {
                                        if($amount[$i]==0||$date[$i]==""||$std[$i]==""||$particulars[$i]=="")
                                            $f=0;
                                    }
                                    if($f==0)
                                    {
                                    ...
                                    else
                                    {
                                        ...
                                        for($i=0;$i<$count;$i++)
                                        {
                                            $n=trim($particulars[$i]);
                                            $s=trim($std[$i]);
                                            $d=trim($date[$i]);
                                            $t=trim($amount[$i]);
                                            $id1=$id[$i];
                                            $sql1 = "UPDATE fees SET std='$s',particulars='$n',date='$d', amount='$t' WHERE id='$id1'";
                                        ...
                                        if($f!=0)
                                        {
                                          ...
                                          echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_editfees.php\">";
                                        }
                                    }
