                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    ...
                                    <?php
                                        require('db.php');
                                        $query="SELECT * from timetable GROUP BY std;";
                                        ...
                                        while($rows=mysqli_fetch_array($result))
                                        {
                                            ?>  <tr>
                                                    <td><?php echo $i ?></td>
                                                    <td><a href = "edittimetable.php?std=<?php echo $rows['std'];?>"><?php echo $rows['std'];?></td>
                                                    <?php 
                                                        $st=$rows['std'];
                                                        $query3="SELECT * from class WHERE std='$st'";
                                                    ...
                                                    <?php 
                                                        $query2="SELECT * from student WHERE std='$st'";
