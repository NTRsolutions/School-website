                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <tbody>
                                    ...
                                    <?php
                                        require('db.php');
                                        $sql="SELECT * FROM timetable GROUP BY std";
                                        $result=mysqli_query($stat,$sql);
                                        $count=mysqli_num_rows($result);
                                        while($rows=mysqli_fetch_array($result)){
                                        ?>
                                        <tr>
                                            <td><input id="checkbox[]" name="checkbox[]" style="width: 15px;height: 15px" type="checkbox" value="<?php echo $rows['std']; ?>" ></td>
                                            <td id="std1[]" name="std1[]"><?php echo $rows['std']; ?></td>
                                            <?php 
                                                $s=$rows['std'];
                                                $query3="SELECT * from class WHERE std='$s'";
                                    ...
                                    <button name="delete" type="submit" id="delete2" class="btn btn-danger">Delete</button>
                                    </form>
                                    <?php
                                        if(isset($_POST['delete']))
                                        {
                                            if(@$checkbox = $_POST['checkbox'])
                                            {
                                              ...
                                              {
                                                $del_id=$checkbox[$i];
                                                $sql = "DELETE FROM timetable WHERE std='$del_id'";
                                                $result = mysqli_query($stat,$sql);
                                              }
                                              echo"
                                              ...
                                              echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_deltimetable.php\">";               
                                            }
                                            else
                                            {
                                              echo"
