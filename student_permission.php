        ...
        function succ()
        {
            echo"
              <script type='text/javascript'>
                    ...
                    ;
               echo "<meta http-equiv=\"refresh\" content=\"0;URL=student_permission.php\">";
        }
        $subject="";
        $body="";
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-dashboard"></i> Send request to administrator to get Permission.
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea class="form-control" rows="15" name="body" required autocomplete="off" ><?php echo $body; ?></textarea></td>
                                    </tr>
                                    </tbody>
                                    </table>
